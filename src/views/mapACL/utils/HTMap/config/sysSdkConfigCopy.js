 ...
 * 适配 sophon 项目的配置加载方式
 * 
 * 注意：mapConfig.js 通过 <script> 标签加载，创建全局变量 
 * - 开发模式：从 import.meta.env 获取配置
 * - 打包模式：nginx 替换 PLACEHOLDER
 */
...
const getBasePath = () => {
  ...
  // 生产环境
  return import.meta.env.BASE_URL || '/sophon'
}

// 腾讯地图SDK配置
export const tencentSDKConfig = {
  js: [
    mapConfig.tencent.url,
...
// 四维图新MineMap SDK配置    开发环境使用外网CDN，生产环境使用本地文件
export const minemapSDKConfig = (() => {
  ...
  if (isDev) {
    ...
    return {
      css: [
        `${mapConfig.minemap.pluginsUrl}nce-static/support/demo/js-api/zh/css/demo.css`,
        `${mapConfig.minemap.url}minemapapi/v2.1.1/minemap.css`,
        `${mapConfig.minemap.url}minemapapi/v2.1.1/minemap-dark.css`
      ],
      js: [
        `${mapConfig.minemap.url}minemapapi/v2.1.1/minemap.js`,
        `${mapConfig.minemap.url}minemapapi/minemap-plugins/2d-util/minemap-util.js`,
        `${mapConfig.minemap.pluginsUrl}minemapapi/minemap-plugins/template/template.js`
      ],
      version: '2.1.1',
      required: ['minemap'],
      maxZoom: 22,
    ...
    // 生产环境（包括视频网和公安网）：使用本地文件
    return {
      css: [
        `${basePath}/minemap/css/minemap.css`,
        `${basePath}/minemap/css/minemap-dark.css`,
        `${basePath}/minemap/css/minemap-edit.css`
      ],
      js: [
        `${basePath}/minemap/js/minemap.js`,
        `${basePath}/minemap/js/minemap-util.js`,
        `${basePath}/minemap/js/minemap-edit.js`
      ],
      version: '2.1.1',
      required: ['minemap'],
      maxZoom: 22,
...
export const mapboxSDKConfig = {
  js: `${mapConfig.mapbox}v3.14.0/mapbox-gl.js`,
  css: `${mapConfig.mapbox}v3.14.0/mapbox-gl.css`,
  version: '2.15.0',
  required: ['mapboxgl'],
  // MapboxGL特有配置
  maxZoom: 24,
